...
class TCBlobDownloadManagerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        do {
            try FileManager.default.createDirectory(at: kTestsDirectory, withIntermediateDirectories: true)
        } catch {
    ...
    func waitForExpectationsWithDefaultHandler(_ timeout: TimeInterval = 10, handler: XCWaitCompletionHandler! = { if $0 != nil {print($0 ?? "null")} }) {
