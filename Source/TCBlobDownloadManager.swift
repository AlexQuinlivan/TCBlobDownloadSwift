...
class DownloadDelegate: NSObject, URLSessionDownloadDelegate {
    ...
    let acceptableStatusCodes: CountableClosedRange<Int> = 200...299
    ...
    func urlSession(_ session: URLSession, downloadTask: URLSessionDownloadTask, didFinishDownloadingTo location: URL) {
        ...
        do {
            try FileManager.default.replaceItem(at: download.destinationURL, withItemAt: location, backupItemName: nil, resultingItemURL: &resultingURL)
