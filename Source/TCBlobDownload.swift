...
extension TCBlobDownload: CustomStringConvertible {
    public var description: String {
        ...
        parts.append("URL: \(self.downloadTask.originalRequest?.url?.description ?? "null")")
        parts.append("Download task state: \(state)")
        parts.append("destinationPath: \(self.directory?.description ?? "null")")
        parts.append("fileName: \(self.fileName ?? "null")")
